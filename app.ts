...
if (process.env.NODE_ENV !== 'production') {
  app.listen(PORT, () => {
    ...
    console.log(`\n👤 Profiles:`);
    console.log(`   GET    /profiles             - Get current user profile (protected)`);
    console.log(`   PUT    /profiles             - Update user profile (protected)`);
    console.log(`   PUT    /profiles/avatar      - Update user avatar (protected)`);
    console.log(`\n📂 Categories:`);
    console.log(`   GET    /categories           - Get all categories`);
    console.log(`   GET    /categories/:id       - Get single category`);
    console.log(`   POST   /categories           - Create category (admin)`);
    console.log(`   PUT    /categories/:id       - Update category (admin)`);
    console.log(`   DELETE /categories/:id       - Delete category (admin)`);
    console.log(`\n💚 Health:`);
